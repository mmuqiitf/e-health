...
class ClinicPolicy
{
    ...
    {
        return $user->hasPermissionTo('read_clinic');
    }
    ...
    {
        return $user->hasPermissionTo('create_clinic');
    }
    ...
    {
        return $user->hasPermissionTo('update_clinic');
    }
    ...
    {
        return $user->hasPermissionTo('delete_clinic');
    }
