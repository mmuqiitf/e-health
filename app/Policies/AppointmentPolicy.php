...
class AppointmentPolicy
{
    ...
    {
        return $user->hasPermissionTo('read_appointment');
    }
    ...
    /**
     * Determine whether the user can create payment for the appointment.
     */
    public function payment(User $user, Appointment $appointment): bool
    {
        return $user->hasPermissionTo('payment_appointment');
    }
}
