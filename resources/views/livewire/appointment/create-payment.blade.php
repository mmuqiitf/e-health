                ...
                <form wire:submit.prevent="store">
                    <div class="grid grid-cols-12 mb-3">
                        <div class="col-span-12">
                            ...
                            <div class="mt-2">
                                <p class="py-1 text-gray-600">Patient: {{ $appointment->patient->name }}</p>
                                <p class="py-1 text-gray-600">Clinic: {{ $appointment->clinic->name }}</p>
                                <p class="py-1 text-gray-600">Schedule: {{ $appointment->schedule }}</p>
                                <p class="py-1 text-gray-600">Complaint: {{ $appointment->complaint }}</p>
                                <p class="py-1 text-gray-600">Status: {{ $appointment->status }}</p>
                            </div>
                        </div>
                    </div>
